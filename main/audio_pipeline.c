...
size_t audio_pipeline_read(audio_pipeline_t *pipeline, int16_t *buffer, size_t frames)
{
    ...
    size_t bytes_read;
    esp_err_t ret = i2s_channel_read(pipeline->rx_handle, buffer, frames * sizeof(int16_t), &bytes_read, portMAX_DELAY);
...
size_t audio_pipeline_write(audio_pipeline_t *pipeline, const int16_t *buffer, size_t frames)
{
    ...
    esp_err_t ret = i2s_channel_write(pipeline->tx_handle, buffer, frames * sizeof(int16_t), &bytes_written, portMAX_DELAY);
